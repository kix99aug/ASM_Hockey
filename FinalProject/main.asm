...
STA:                                   ;¿ן¨תstart®ֹ×÷₪¶­±
	...
	mov dh,20
	call Gotoxy
	mov edx,OFFSET start               ;¦L¥X¿ן¨תstart×÷°²¶H
	call WriteString
	mov dl,53
	mov dh,21
	call Gotoxy
	...
	call WriteString
	call Sound
	jmp L3                             ;¿י₪Jֱה½L₪W¡B₪U©־enter
	L3:
	mov eax,50
    call Delay
	call ReadKey                       ;ֵ×¨תֱה½L¿י₪J
	cmp dx,+40
	je SET                             ;°»´ת¨ל₪U
	cmp dx,+38
	je OPERA                             ;°»´ת¨ל₪W
	cmp dx,+13                 
	je GAME_PART                      ;°»´ת¨לenter
...
OPERA:
	...
	mov dh,20
	call Gotoxy
	mov edx,OFFSET start1               ;¦L¥X¿ן¨תstart×÷°²¶H
	call WriteString
	mov dl,53
	mov dh,21
	call Gotoxy
